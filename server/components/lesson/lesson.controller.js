const { getAllLessonService,
    getLessonServiceByID,
    addNewLessonService,
    updateLessonServiceByID,
    deleteLessonService } = require('./lesson.service');
...
module.exports = { createLesson, getAllLessonInfo, getLessonByID, updateLesson, deleteLesson }